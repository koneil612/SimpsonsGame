...
insert into levels(level, background, speed, timer, amount) values(1,'background.png',0.8,30,5);insert into levels(level, background, speed, timer, amount) values(2,'powerplant.png',0.9,45,10);insert into levels(level, background, speed, timer, amount) values(3,'prison.png',1.1,60,15);insert into levels(level, background, speed, timer, amount) values(4,'duff.png',1.2,45,10);insert into levels(level, background, speed, timer, amount) values(5,'moes.png',1.4,30,15);


INSERT INTO public."user"(id, username, password, level, score, highscore)VALUES (1, marge, maggie, 3, 30, 250); INSERT INTO public."user"(id, username, password, level, score, highscore)VALUES (2, bart, dude, 1, 10, 1000);
