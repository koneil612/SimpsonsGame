...
insert into zombies(name, img_path) values ('Bart','bartsm.png');insert into zombies(name, img_path) values ('Apu','apusm.png');insert into zombies(name, img_path) values ('Cat','catsm.png');insert into zombies(name, img_path) values ('Duffman','duffmansm.png');insert into zombies(name, img_path) values ('Flanders','flanderssm.png');insert into zombies(name, img_path) values ('Grandpa','grandpasm.png');insert into zombies(name, img_path) values ('Homer','homersm.png');insert into zombies(name, img_path) values ('Krusty','krustysm.png');insert into zombies(name, img_path) values ('Lisa','lisasm.png');insert into zombies(name, img_path) values ('Marge','margesm.png');
...
insert into scores(name, score) values ('Homer', 20);insert into scores(name, score) values ('Troy McClure', 69);insert into scores(name, score) values ('Patty Bouvier', 30);insert into scores(name, score) values ('Atom Man', 100);insert into scores(name, score) values ('Ned Flanders', 400);
